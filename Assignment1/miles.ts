...
const conversionFactor: number= 1.60934;

const kilometers: number= miles * conversionFactor;
...
function Calculator(a: number, b: number, myopr: string){
    if(myopr === "+"){
        return a + b
    }else if(myopr === "-"){
        return a - b
...
let anonymousFunction = function(mymessage:string){
...
// Normal Function 
function normalFunction(myMessage: string){
    console.log(myMessage)
}
//calling the function
